package com.straccion.dao.post_comments
    ...
    override suspend fun addComment(postId: Long, userId: Long, content: String): PostCommentRow? {
        return dbQuery {
            ...
            PostCommentsTable
                ...
                .selectAll().where { (PostCommentsTable.postId eq postId) and (PostCommentsTable.commentId eq commentId) }
                .singleOrNull()
    ...
    override suspend fun getComments(postId: Long, pageNumber: Int, pageSize: Int): List<PostCommentRow> {
        return dbQuery {
            PostCommentsTable
                ...
                .selectAll().where {PostCommentsTable.postId eq postId}
